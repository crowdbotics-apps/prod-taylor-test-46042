"""
Django settings for prod_taylor_test_46042 project.
...
ROOT_URLCONF = 'prod_taylor_test_46042.urls'
...
WSGI_APPLICATION = 'prod_taylor_test_46042.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prod_taylor_test_46042 API",
    "DESCRIPTION": "API documentation for prod_taylor_test_46042 App",
    "VERSION": "v1",
}
